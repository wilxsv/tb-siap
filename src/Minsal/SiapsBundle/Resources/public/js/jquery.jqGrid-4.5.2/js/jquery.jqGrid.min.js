                ...
                if ("TABLE" !== this.tagName.toUpperCase())
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)
                        ...
                        var o = function(a, b) {
                            ...
                            f === "rtl" && (g = g + i);
                            a.p.pginput === true && (e = "<td dir='" + f + "'>" + b.jgrid.format(a.p.pgtext || "", "<input readonly='readOnly' class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" +
