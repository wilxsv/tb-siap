...
class MntEmpleadoAdminController extends Controller {
    ...
    public function createAction() {
        ...
        $modalidades = array();
        if ($object->getIdTipoEmpleado() == 2) {
            $modalidades = $em->getRepository('MinsalSiapsBundle:MntEmpleadoEspecialidadEstab')->findBy(array('idEmpleado' => $object->getId(), 'idAtenAreaModEstab' => null));
        }
    ...
    public function editAction($id = null) {
        ...
        $this->get('twig')->getExtension('form')->renderer->setTheme($view, $this->admin->getFormTheme());
        $modalidades = array();
        if ($object->getIdTipoEmpleado()->getId() == 2) {
            $modalidades = $em->getRepository('MinsalSiapsBundle:MntEmpleadoEspecialidadEstab')->findBy(array('idEmpleado' => $object->getId(), 'idAtenAreaModEstab' => null));
        }
        return $this->render($this->admin->getTemplate($templateKey), array(
                    'action' => 'edit',
