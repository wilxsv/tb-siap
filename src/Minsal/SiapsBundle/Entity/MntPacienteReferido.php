...
class MntPacienteReferido
{
    ...
    */
    ...
    /**
     * @var \Minsal\LaboratorioBundle\Entity\CtlModulo
     *
    ...
    /**
     * @var \Minsal\SeguimientoBundle\Entity\SecRemisionPaciente
     *
     * @ORM\ManyToOne(targetEntity="Minsal\SeguimientoBundle\Entity\SecRemisionPaciente")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="id_referencia_origen", referencedColumnName="id")
     * })
     */
     ...
     *
     * @param \Minsal\SeguimientoBundle\Entity\SecRemisionPaciente $idReferenciaOrigen
     * @return MntPacienteReferido
     */
    public function setIdReferenciaOrigen(\Minsal\SeguimientoBundle\Entity\SecRemisionPaciente $idReferenciaOrigen = null)
    {
    ...
    public function getDireccionDepartamentoConcat(){
        return $this->direccion.', '.$this->idMunicipioDomicilio ?:'';
    }
