...
class TarSolicitudFvihAdmin extends Admin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            //->addIdentifier('fechaHoraRegistro', 'date', array('label'=>'Fecha de registro'))
...
//            ->add('idMotivoSolicitud', null, array('label'=>'Motivo Solicitud'))
    ...
    protected function configureRoutes(RouteCollection $collection) {
        ...
        //
       // $collection->add('showespe','showespe/{idpaciente}/{idespe}');
