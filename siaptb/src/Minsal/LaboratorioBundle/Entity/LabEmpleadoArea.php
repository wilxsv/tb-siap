 ...
 * LabEmpleadoArea
 *
 * @ORM\Table(name="lab_empleado_area", indexes={@ORM\Index(name="IDX_73B9E092992127D5", columns={"id_area_servicio_diagnostico"}), @ORM\Index(name="IDX_73B9E092890253C7", columns={"id_empleado"})})
 * @ORM\Entity
 */
class LabEmpleadoArea
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="lab_empleado_area_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
