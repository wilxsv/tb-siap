 ...
 */
class CtlPais extends \Minsal\SiapsBundle\Entity\CtlPais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlPais' . "\0" . 'id', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlPais' . "\0" . 'nombre', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlPais' . "\0" . 'activo');
        }
