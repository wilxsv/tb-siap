 ...
 */
class CtlTipoObjeto extends \Application\CoreBundle\Entity\CtlTipoObjeto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\CoreBundle\\Entity\\CtlTipoObjeto' . "\0" . 'id', '' . "\0" . 'Application\\CoreBundle\\Entity\\CtlTipoObjeto' . "\0" . 'nombre', '' . "\0" . 'Application\\CoreBundle\\Entity\\CtlTipoObjeto' . "\0" . 'codigo', '' . "\0" . 'Application\\CoreBundle\\Entity\\CtlTipoObjeto' . "\0" . 'aplicaPara', '' . "\0" . 'Application\\CoreBundle\\Entity\\CtlTipoObjeto' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CtlTipoObjeto $proxy) {
