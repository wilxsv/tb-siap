 ...
 */
class FrmSeccion extends \Application\CoreBundle\Entity\FrmSeccion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\CoreBundle\\Entity\\FrmSeccion' . "\0" . 'id', '' . "\0" . 'Application\\CoreBundle\\Entity\\FrmSeccion' . "\0" . 'nombre', '' . "\0" . 'Application\\CoreBundle\\Entity\\FrmSeccion' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FrmSeccion $proxy) {
