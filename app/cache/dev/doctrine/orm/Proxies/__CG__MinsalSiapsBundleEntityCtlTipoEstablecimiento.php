 ...
 */
class CtlTipoEstablecimiento extends \Minsal\SiapsBundle\Entity\CtlTipoEstablecimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlTipoEstablecimiento' . "\0" . 'id', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlTipoEstablecimiento' . "\0" . 'nombre', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\CtlTipoEstablecimiento' . "\0" . 'codigo');
        }
