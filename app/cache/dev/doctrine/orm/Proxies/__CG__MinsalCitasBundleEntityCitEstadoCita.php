 ...
 */
class CitEstadoCita extends \Minsal\CitasBundle\Entity\CitEstadoCita implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\CitasBundle\\Entity\\CitEstadoCita' . "\0" . 'id', '' . "\0" . 'Minsal\\CitasBundle\\Entity\\CitEstadoCita' . "\0" . 'estado', '' . "\0" . 'Minsal\\CitasBundle\\Entity\\CitEstadoCita' . "\0" . 'descripcion', '' . "\0" . 'Minsal\\CitasBundle\\Entity\\CitEstadoCita' . "\0" . 'idusuarioreg', '' . "\0" . 'Minsal\\CitasBundle\\Entity\\CitEstadoCita' . "\0" . 'fechahorareg');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CitEstadoCita $proxy) {
