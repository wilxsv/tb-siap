...
class User extends \Application\Sonata\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setGuidCreatedAt($guidCreatedAt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGuidCreatedAt', array($guidCreatedAt));

        return parent::setGuidCreatedAt($guidCreatedAt);
    }
    ...
    public function getGuidCreatedAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGuidCreatedAt', array());

        return parent::getGuidCreatedAt();
    }
