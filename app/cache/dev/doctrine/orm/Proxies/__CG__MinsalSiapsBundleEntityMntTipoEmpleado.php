 ...
 */
class MntTipoEmpleado extends \Minsal\SiapsBundle\Entity\MntTipoEmpleado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntTipoEmpleado' . "\0" . 'id', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntTipoEmpleado' . "\0" . 'codigo', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntTipoEmpleado' . "\0" . 'tipo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MntTipoEmpleado $proxy) {
