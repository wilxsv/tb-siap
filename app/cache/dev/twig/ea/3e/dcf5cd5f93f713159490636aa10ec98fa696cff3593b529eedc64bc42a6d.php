...
/* MinsalSeguimientoBundle:SecIngreso:resultado_reporte_list.html.twig */
class __TwigTemplate_ea3edcf5cd5f93f713159490636aa10ec98fa696cff3593b529eedc64bc42a6d extends Twig_Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["paciente"]) {
            ...
            echo "</td>
              <td>";
            // line 58
            echo twig_escape_filter($this->env, ((twig_date_format_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "fecha", array(), "array"), "d/m/Y") . " ") . twig_date_format_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "hora", array(), "array"), "H:i")), "html", null, true);
            echo "</td>
              <td>";
            // line 59
    ...
    public function block_javascripts($context, array $blocks = array())
    {
        ...
        jQuery(document).ready(function (\$) {
            ...
            \$('#exportar_hoja_calculo').click(function() {
                url = Routing.generate('total_ingresos',{'report_name':'rpt_resumen_ingresos','report_format':'XLS','datos':\$('#pacientesIngresados').serialize()});
                window.open(url, '_blank');
                return false;
            });
            \$('#exportar_pdf').click(function() {
                url = Routing.generate('total_ingresos',{'report_name':'rpt_resumen_ingresos','report_format':'PDF','datos':\$('#pacientesIngresados').serialize()});
                window.open(url, '_blank');
                return false;
...
";
    ...
    {
        return "MinsalSeguimientoBundle:SecIngreso:resultado_reporte_list.html.twig";
    }
