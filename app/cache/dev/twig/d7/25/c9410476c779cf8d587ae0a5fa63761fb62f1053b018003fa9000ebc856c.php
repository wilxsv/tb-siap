...
/* MinsalCitasBundle:Reports/CitasMedicas:cargarFechasLibres.html.twig */
class __TwigTemplate_d725c9410476c779cf8d587ae0a5fa63761fb62f1053b018003fa9000ebc856c extends Twig_Template
{
    ...
    <tbody>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["horariosDisponibles"]) ? $context["horariosDisponibles"] : $this->getContext($context, "horariosDisponibles")));
        foreach ($context['_seq'] as $context["_key"] => $context["horario"]) {
            // line 34
            echo "            <tr>
                <td>";
            // line 35
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "medico", array(), "array"), "html", null, true);
            echo "</td>
                ";
            // line 36
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array")) > 0)) {
                // line 37
                echo "                <td>
                        ";
                // line 38
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array"), 0, array(), "array"), "fecha", array(), "array"), "html", null, true);
                echo " Con el horario ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array"), 0, array(), "array"), "rangoHora", array(), "array"), "html", null, true);
                echo "
                        ";
                // line 39
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array"), 0, array(), "array"), "distribucionMedica", array(), "array"), "idTipoDistribucion", array(), "array")) {
                    // line 40
                    echo "                            Para el tipo de distribución ";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array"), 0, array(), "array"), "distribucionMedica", array(), "array"), "nombreTipoDistribucion", array(), "array"), "html", null, true);
                    echo "
                        ";
                }
                // line 42
                echo "                        ";
                $context["diasEspera"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "primeravez", array(), "array"), 0, array(), "array"), "fechaObjeto", array(), "array"), "diff", array(0 => $this->getAttribute(twig_date_converter($this->env), "setTime", array(0 => 0, 1 => 0), "method")), "method"), "format", array(0 => "%a"), "method");
                // line 43
                echo "                </td>
                <td>";
                // line 44
                echo (isset($context["diasEspera"]) ? $context["diasEspera"] : $this->getContext($context, "diasEspera"));
                echo "</td>
                ";
            } else {
                // line 46
                echo "                    <td>NO HAY DISTRIBUCIÓN ASIGNADA</td>
                    <td>N/A</td>
                ";
            }
            // line 49
            echo "                ";
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array")) > 0)) {
                // line 50
                echo "                <td>
                    ";
                // line 51
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array"), 0, array(), "array"), "fecha", array(), "array"), "html", null, true);
                echo " Con el horario ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array"), 0, array(), "array"), "rangoHora", array(), "array"), "html", null, true);
                echo "
                    ";
                // line 52
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array"), 0, array(), "array"), "distribucionMedica", array(), "array"), "idTipoDistribucion", array(), "array")) {
                    // line 53
                    echo "                        Para el tipo de distribución ";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array"), 0, array(), "array"), "distribucionMedica", array(), "array"), "nombreTipoDistribucion", array(), "array"), "html", null, true);
                    echo "
                    ";
                }
                // line 55
                echo "                    ";
                $context["diasEspera"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "subsecuente", array(), "array"), 0, array(), "array"), "fechaObjeto", array(), "array"), "diff", array(0 => $this->getAttribute(twig_date_converter($this->env), "setTime", array(0 => 0, 1 => 0), "method")), "method"), "format", array(0 => "%a"), "method");
                // line 56
                echo "                </td>
                <td>";
                // line 57
...
";
    ...
    {
        return "MinsalCitasBundle:Reports/CitasMedicas:cargarFechasLibres.html.twig";
    }
