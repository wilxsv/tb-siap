...
/* MinsalSeguimientoBundle:SecIngreso:resultado_busqueda.html.twig */
class __TwigTemplate_33a0d32291d7f7ddb01d9d8e8d993515fb36e379e3f1fe81ae4f90ba7dd653ac extends Twig_Template
{
  ...
  <div class=\"col-md-offset-3 col-md-2\">
    <h3 class=\"text-center\">Pacientes Ingresados</h3>
  </div>
</div>
<table id=\"tablaResultados\" class=\"table table-bordered table-hover\" data-table-enabled=\"true\">
    <thead>
        <tr>
            ...
            <th>Tarjetas Entregadas</th>
            <th>Servicio en que ingreso</th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["paciente"]) {
            ...
            echo "            <tr>
              <td>
                 <a href=\"";
            // line 39
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("hoja_ingreso_egreso", array("report_name" => "hojaIngresoEgreso", "report_format" => "PDF", "paciente" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id", array(), "array"), "ingreso" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id_ingreso", array(), "array"))), "html", null, true);
            echo "\" target=\"_blank\" class=\"btn btn-info\"><span class=\"glyphicon glyphicon-book\"></span> Hoja de Ingreso</a>
                 <a href=\"";
            // line 40
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_minsal_seguimiento_secingreso_edit", array("id" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id_ingreso", array(), "array"))), "html", null, true);
            echo "\" class=\"btn btn-info\"><span class=\"glyphicon glyphicon-pencil\"></span> Editar</a>
                 ";
            // line 41
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "validate_ingreso_hospitalario"), "method") == false)) {
                // line 42
                echo "                    <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_minsal_seguimiento_secingreso_delete", array("id" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id_ingreso", array(), "array"))), "html", null, true);
                echo "\" class=\"btn btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span> Borrar </a>
                 ";
            }
            // line 44
            echo "              </td>
            ...
            echo "</td>
              <td>";
            // line 49
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "tarjetas", array(), "array"), "html", null, true);
            echo "</td>
              <td>";
            // line 50
...
";
    ...
    {
        return "MinsalSeguimientoBundle:SecIngreso:resultado_busqueda.html.twig";
    }
