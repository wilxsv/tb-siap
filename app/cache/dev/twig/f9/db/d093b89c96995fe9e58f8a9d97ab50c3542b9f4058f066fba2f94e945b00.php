...
/* MinsalSeguimientoBundle:SecRemisionPacienteAdmin:encabezado_paciente.html.twig */
class __TwigTemplate_f9dbd093b89c96995fe9e58f8a9d97ab50c3542b9f4058f066fba2f94e945b00 extends Twig_Template
{
...
<table class=\"vista_paciente\" border=\"0\" width=\"100%\">
    ...
    <tr class=\"dat_paciente_content\">
        ...
        echo "</td>
        <td><label>Area Geografica:</label></td><td>";
        // line 21
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["expediente"]) ? $context["expediente"] : $this->getContext($context, "expediente")), "getIdPaciente", array(), "method"), "getAreaGeograficaDomicilio", array(), "method"), "html", null, true);
        echo "</td>
    </tr>
    <tr>
...
";
    ...
    {
        return "MinsalSeguimientoBundle:SecRemisionPacienteAdmin:encabezado_paciente.html.twig";
    }
