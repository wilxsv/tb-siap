...
/* MinsalSiapsBundle:MntExpedienteAdmin:cargar_expediente_eliminar.html.twig */
class __TwigTemplate_4c5b148e7f11b74eb87fecc5b378d6bd0dabaf431c9ef0b534be91cbd2929543 extends Twig_Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["paciente"]) {
            // line 68
            echo "            ";
            if ((!($this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "numero", array(), "array") === "EM"))) {
                // line 69
                echo "                ";
                if ((((!$this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "numero_temporal", array(), "array")) && (!$this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "expediente_fisico_eliminado", array(), "array"))) || ($this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "numero_temporal", array(), "array") && $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "expediente_fisico_eliminado", array(), "array")))) {
                    // line 70
                    echo "                    <tr>
                      <td>
                          ";
                    ...
                    if ($this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "expediente_fisico_eliminado", array(), "array")) {
                        // line 73
                        echo "                                <a style=\"color: #FFFFFF\" href=\"#\" class=\"btn btn-success deshabilitarExpediente\"
                                  numeroExpediente='";
                        // line 74
                        ...
                        echo "'
                                  idExpediente='";
                        // line 75
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id_expediente", array(), "array"), "html", null, true);
                        echo "'
                                  accion='habilitar'
                                 >
                        ...
                        // line 81
                        echo "                                 <a style=\"color: #FFFFFF\" href=\"#\" class=\"btn btn-danger deshabilitarExpediente\"
                                    numeroExpediente='";
                        // line 82
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "numero", array(), "array"), "html", null, true);
                        echo "'
                    ...
                    // line 96
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_report_paciente", array("report_name" => "hoja_datos_paciente", "report_format" => "PDF", "paciente" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id", array(), "array"))), "html", null, true);
                    echo "\" class=\"btn btn-info\"><span class=\"fa fa-file-text\"></span>Hoja Identificación</a></td>
                  </tr>
                  ";
                }
                // line 99
...
";
    ...
    {
        return "MinsalSiapsBundle:MntExpedienteAdmin:cargar_expediente_eliminar.html.twig";
    }
