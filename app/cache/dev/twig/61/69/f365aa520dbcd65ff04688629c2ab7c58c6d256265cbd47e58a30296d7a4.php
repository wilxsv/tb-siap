...
/* MinsalCitasBundle:CitasMedicas:estadisticaMedico.html.twig */
class __TwigTemplate_6169f365aa520dbcd65ff04688629c2ab7c58c6d256265cbd47e58a30296d7a4 extends Twig_Template
{
...
";
    ...
    \$(document).ready(function () {
        ...
        initializeSelect2(anio, true, false, {
            placeholder: 'Seleccione...',
            allowClear: true,
            width: '100%'
        });
        ...
        \$('#buscar').on('click',function(e){
            if(anio.select2('val')!='' && idAtenAreaModEstab.select2('val')!=''){
                \$('#resultado').waitMe({ text: 'Buscando...' });
                \$('#resultado').css({'overflow-y':'scroll',
                    'overflow-y': 'hidden'
                });
                \$('#resultado').load(Routing.generate(\"consulta_estadistica_medico\",{'datos':\$('#formBusqueda').serialize()}),
                ...
                var body=\"Debe de seleccionar el año y la especialidad para generar el reporte\";
...
";
    ...
    <div class=\"row\">
        <form id=\"formBusqueda\" method=\"post\" >
            <div class=\"col-md-7 col-md-offset-2\">
                <h2 class=\"text-center\">Estadistica de Citas Programadas por Médico</h2>
                <img src=\"";
        // line 132
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/minsalsiaps/imagenes/estadistica.png"), "html", null, true);
        ...
        echo "                          </select></td>
                      ...
                      <tr>
                          <th>Año *:</th>
                          <td>
                              <select id=\"anio\" name=\"anio\" style=\"width:400px !important;\">
                                  ";
        // line 151
        $context['_parent'] = (array) $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["anio"]) {
            // line 152
            echo "                                      <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["anio"]) ? $context["anio"] : $this->getContext($context, "anio")), "anio", array(), "array"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["anio"]) ? $context["anio"] : $this->getContext($context, "anio")), "anio", array(), "array"), "html", null, true);
            echo "</option>
                                  ";
    ...
    <br/>
    <div class=\"row\">
        <div id=\"resultado\" class=\"col-md-12 center-block\" style=\"min-height: 150px;\">
        </div>
    </div>
</div>
";
    ...
    {
        return "MinsalCitasBundle:CitasMedicas:estadisticaMedico.html.twig";
    }
