...
/* MinsalSiapsBundle:MntPacienteAdmin:encabezado_paciente.html.twig */
class __TwigTemplate_12da4468329f4fbe74d46445429311a74cd6bac1fb247612d5bd13e2d3ec9832 extends Twig_Template
{
...
<table class=\"vista_paciente\" border=\"0\" width=\"100%\">
    <tr class=\"titulo_vista\">
        <td colspan=\"4\"><b>Identificación del Paciente</b></td>
    </tr>
    <tr class=\"dat_paciente_content\">
        <td ><label>Número Expediente:</label></td>
    ...
    <tr class=\"dat_paciente_content\">
        <td><label id=\"edad_paciente\" value=\"";
        // line 22
        echo twig_escape_filter($this->env, (isset($context["edad"]) ? $context["edad"] : $this->getContext($context, "edad")), "html", null, true);
        echo "\">Edad:</label></td><td>";
        echo twig_escape_filter($this->env, (isset($context["edad"]) ? $context["edad"] : $this->getContext($context, "edad")), "html", null, true);
        echo "</td>
        <td><label id=\"sexo_paciente\" value=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["expediente"]) ? $context["expediente"] : $this->getContext($context, "expediente")), "getIdPaciente", array(), "method"), "getIdSexo", array(), "method"), "getAbreviatura", array(), "method"), "html", null, true);
        echo "\">Sexo:</label></td><td>";
    ...
    <tr class=\"dat_paciente_content\">
        ...
        echo "</td>
        <td><label>Documento Identidad:</label></td><td>";
        // line 27
    ...
    <tr>
        ...
        <td colspan=\"3\"> ";
        // line 31
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["expediente"]) ? $context["expediente"] : $this->getContext($context, "expediente")), "getIdPaciente", array(), "method"), "getDireccion", array(), "method"), "html", null, true);
        echo "</td>
    </tr>
    <tr class=\"dat_paciente_content\">
        <td><label>Departamento Domicilio:</label></td><td>";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["expediente"]) ? $context["expediente"] : $this->getContext($context, "expediente")), "getIdPaciente", array(), "method"), "getIdDepartamentoDomicilio", array(), "method"), "html", null, true);
        echo "</td>
        <td><label>Municipio Domicilio:</label></td><td>";
        // line 35
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["expediente"]) ? $context["expediente"] : $this->getContext($context, "expediente")), "getIdPaciente", array(), "method"), "getIdMunicipioDomicilio", array(), "method"), "html", null, true);
        echo "</td>
    </tr>
</table>
<br/>
...
";
    ...
    {
        return "MinsalSiapsBundle:MntPacienteAdmin:encabezado_paciente.html.twig";
    }
