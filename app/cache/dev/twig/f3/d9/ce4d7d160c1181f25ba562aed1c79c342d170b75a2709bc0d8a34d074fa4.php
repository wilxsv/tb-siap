...
/* MinsalLaboratorioBundle:Custom/SecSolicitudestudios:reporte_solicitudestudios.html.twig */
class __TwigTemplate_f3d9ce4d7d160c1181f25ba562aed1c79c342d170b75a2709bc0d8a34d074fa4 extends Twig_Template
{
    ...
    {
        // line 2
        $context["nombreReporte"] = "BOLETA DE SOLICITUD DE PRUEBAS DE LABORATORIO";
        // line 3
        $context["lab_section"] = true;
        // line 4
        echo "<html>
<head>
    ...
    .panel-body, .vista_paciente,.table.table-bordered.table-hover,.table-bordered {font-size: 12px;}
    td,th {padding: 5px 10px;}
    .table-header td, .table-header th {padding: 2px 5px;}
...
<body >
    ";
        ...
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : $this->getContext($context, "params")), "solicitudEstudio"), "laboratorio")) > 0)) {
            // line 31
            echo "        ";
            if (($this->getAttribute((isset($context["params"]) ? $context["params"] : $this->getContext($context, "params")), "singlePrint") == true)) {
                // line 32
                echo "            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["area"]) {
                    ...
                    // line 40
                    echo "                ";
                    $this->env->loadTemplate("MinsalLaboratorioBundle:Custom:SecSolicitudestudios/body_solicitudestudio_impresion.html.twig")->display($context);
                    // line 41
                    echo "                ";
                    $this->env->loadTemplate("MinsalSeguimientoBundle:Reportes:firma_medico.html.twig")->display($context);
                    // line 42
                ...
                ";
                    // line 43
                    if (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "last") == false)) {
                        // line 44
                        echo "                    <!-- <div style=\"width: 100%;border-bottom: 1px dashed #000000;margin-top:5px;margin-bottom: 15px;\"><span class=\"fa fa-scissors\" aria-hidden=\"true\"></span></div> -->
            ...
            $this->env->loadTemplate("MinsalSiapsBundle:MntPacienteAdmin:encabezado_paciente_reporte.html.twig")->display($context);
            // line 52
            echo "        <div class=\"panel panel-info\" style=\"padding:10px;\">
            No se encontró ningún examen asociado a la solicitud de Laboratorio...
        </div>
    ";
        }
        // line 56
