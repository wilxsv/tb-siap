...
/* MinsalFarmaciaBundle:FarmRecetas:receta0.html.twig */
class __TwigTemplate_8c291ac69049438a66d27d4f401c86b9fc6b560858de2107f5aece7cdde30eb3 extends Twig_Template
{
    ...
    <table width=\"50%\" style=\"float: left;\" border='0'>
        <tr>
        ...
        <tr>               
            <td style=\"font-size: 11px\" colspan=\"2\"><label>No Expediente: </label><b>";
            // line 60
            ...
            echo "</b></td>
            <td style=\"font-size: 11px\" colspan=\"2\"><label>Fecha Entrega: </label><b>";
            // line 61
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["cuantamedicina"]) ? $context["cuantamedicina"] : $this->getContext($context, "cuantamedicina")), "med"), "getIdreceta", array(), "method"), "fecha"), "d-m-Y"), "html", null, true);
            echo "</b></td>
        <tr>
            <td colspan=\"4\" style=\"font-size: 11px\"><label>Horario:</label></td>
        </tr>
        <tr>
        ...
        <tr>    
            <td style=\"width: 25%\"><label>Procedencia: </label>";
            // line 70
        ...
        <tr>
            <td ><label>Fecha consulta:</label></td>
            <td colspan=\"3\">";
            // line 76
        ...
        <tr>
            <td class=\"td-medicamento\" style=\"border-right:  1px solid black;\"><label>Medicamento</label> </td>
            <td class=\"td-medicamento\" style=\"border-right:  1px solid black;\" colspan=\"2\"><label>Dosis:</label></td> 
            <td class=\"td-medicamento\" align = \"center\"><label>Cantidad:</label></td> 
       </tr>
        <tr>
            <td class=\"td-medicamento-detalle\" style=\"border-right:  1px solid black;font-size: 9px;\">";
            // line 84
            ...
            echo "</td>
            <td class=\"td-medicamento-detalle\" style=\"border-right:  1px solid black;font-size: 9px;\" colspan=\"2\">";
            // line 85
            ...
            echo "</td> 
            <td class=\"td-medicamento-detalle\" style=\"font-size: 9px;\" align = \"center\">";
            // line 86
...
") . $this->getAttribute($this->getAttribute((isset($context["idhistorialclinico"]) ? $context["idhistorialclinico"] : $this->getContext($context, "idhistorialclinico")), "idAtenAreaModEstab"), "getNombreConsulta", array(), "method"));
        ...
        <tr>
            <td style=\"text-align: center\"><br/><br/><label>________________<br/>Cantidad Despachada</label> </td>
            <td colspan=\"2\" style=\"text-align: center\"><br/><br/><label>___________________<br/>Auxiliar de Farmacia</label> </td>
            <td style=\"text-align: center\"><br/><br/><label>___________________<br/>Sello de despacho</label> </td> 
        </tr>
    </table>
    ...
    ";
            // line 110
            if (((isset($context["twoxpage"]) ? $context["twoxpage"] : $this->getContext($context, "twoxpage")) > 4)) {
                // line 111
                echo "        <br>
...
";
    ...
    {
        return "MinsalFarmaciaBundle:FarmRecetas:receta0.html.twig";
    }
