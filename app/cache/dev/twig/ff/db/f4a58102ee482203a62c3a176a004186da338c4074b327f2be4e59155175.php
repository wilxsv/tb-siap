...
/* MinsalSeguimientoBundle:SecEmergencia:resultado_busqueda.html.twig */
class __TwigTemplate_ffdbf4a58102ee482203a62c3a176a004186da338c4074b327f2be4e59155175 extends Twig_Template
{
  ...
  <div class=\"col-md-offset-3 col-md-2\">
    <h3 class=\"text-center\">Lista de Emergencias</h3>
  </div>
</div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["paciente"]) {
            ...
            echo "            <tr>
              <td>
                  <a href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_report_seguimiento_paciente", array("report_name" => "rpt_hoja_urgencia", "report_format" => "PDF", "paciente" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id", array(), "array"), "id_emergencia" => $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "id_emergencia", array(), "array"))), "html", null, true);
            echo "\" target=\"_blank\" class=\"btn btn-info\"><span class=\"glyphicon glyphicon-book\"></span> Hoja de Emergencia</a>
              </td>
              <td >";
            // line 38
            ...
            echo "</td>
              <td>";
            // line 42
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "numero_emergencia", array(), "array"), "html", null, true);
            echo "</td>
              <td>";
            // line 43
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["paciente"]) ? $context["paciente"] : $this->getContext($context, "paciente")), "fecha_emergencia", array(), "array"), "d/m/Y"), "html", null, true);
            echo "</td>
          </tr>
        ";
        }
...
";
    ...
    {
        return "MinsalSeguimientoBundle:SecEmergencia:resultado_busqueda.html.twig";
    }
