...
/* MinsalFarmaciaBundle:FarmRecetas:receta.html.twig */
class __TwigTemplate_b761587f4569c96f4c3dc0e5c2f8ccb4acbcea297e9c978a183e0dfb66c90fdb extends Twig_Template
{
...
<html>
    ...
    <table width=\"50%\"  style=\"float: left;\" border='0'>
        ...
        <tr>
            <td colspan=\"4\" style=\"font-size: 16px;text-align:right;\" colspan=\"2\"><label>No Expediente: </label><b>";
            // line 59
            ...
            echo "</b></td>
        <tr>
            <td colspan=\"3\" style=\"font-size: 9px;border:solid 1px\" colspan=\"2\"><label>Fecha Entrega: </label><b>";
            // line 61
            ...
            echo " </b></td>
            <td colspan=\"1\" style=\"font-size: 9px\"><label>Horario: </label><b>";
            // line 62
        ...
        <tr>
            <td colspan=\"2\"><label>Procedencia: </label>";
            // line 69
        ...
        <tr>
            ...
            echo "</td>
            <td colspan=\"2\"><label>Fecha consulta: </label>";
            // line 74
        ...
        <tr>
            <td style=\"font-size: 16px;\" class=\"td-medicamento\" colspan=\"4\"><label>Cantidad: </label>";
            // line 83
...
") . $this->getAttribute($this->getAttribute((isset($context["idhistorialclinico"]) ? $context["idhistorialclinico"] : $this->getContext($context, "idhistorialclinico")), "idAtenAreaModEstab"), "getNombreConsulta", array(), "method"));
            ...
            echo "\" height = '60px'/></td>
            <td colspan=\"2\"><br/><br/><br/><label>";
            // line 88
            echo twig_escape_filter($this->env, twig_title_string_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["idhistorialclinico"]) ? $context["idhistorialclinico"] : $this->getContext($context, "idhistorialclinico")), "getIdEmpleado"), "nombreempleado")), "html", null, true);
            echo "</label></td>
            <td><label><br/><br/><br/>";
            // line 89
        ...
        <tr>
            <td style=\"text-align: center\"><br/><br/><label>_________________<br/>Cantidad Despachada</label> </td>
            <td colspan=\"2\" style=\"text-align: center\"><br/><label>__________________<br/>Auxiliar de Farmacia</label> </td>
            <td style=\"text-align: center\"><br/><label>_________________<br/>Sello de despacho</label> </td>
        </tr>
    </table>
