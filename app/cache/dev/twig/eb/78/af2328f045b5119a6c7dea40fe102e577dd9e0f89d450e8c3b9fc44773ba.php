...
/* MinsalSiapsBundle:MntExpedienteAdmin:reporte_depuracion.html.twig */
class __TwigTemplate_eb78af2328f045b5119a6c7dea40fe102e577dd9e0f89d450e8c3b9fc44773ba extends Twig_Template
{
        ...
        \$(document).ready(function () {
            ...
            \$(\"#emitir_informe\").click(function(event) {
                if (\$(\"#fecha_inicio\").val() == '' || \$(\"#fecha_fin\").val() == '') {
                    ...
                    \$('#resultadoBusqueda').waitMe({'text':'Cargando...'});
                    \$('#resultadoBusqueda').load(Routing.generate('expedientes_creados',{'datos':\$('#buscarForm').serialize(),'tipo':'eliminados'}));
                }
                event.preventDefault();
            });
        });
...
";
    ...
    public function block_sonata_admin_content($context, array $blocks = array())
    {
        ...
        echo " />
            Reporte de Expedientes Físicos Eliminados
        </h2>
