...
/* MinsalCitasBundle:CitCitasProcedimientos:cupos_disponibles.html.twig */
class __TwigTemplate_eb4f5ac5bd82f393ed3d4af35f124397df1ec01f59de3180a970805d113263a3 extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-sm-5\">
            <p style=\"font-size:16px\"><strong>Procedimiento: </strong> ";
        // line 90
        echo twig_escape_filter($this->env, (isset($context["nombreProcedimiento"]) ? $context["nombreProcedimiento"] : $this->getContext($context, "nombreProcedimiento")), "html", null, true);
        echo " </p>
        </div>
        <div class=\"col-sm-5\">
    ...
    <div class=\"row\">
        <div class=\"col-sm-10\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cita"]) {
                // line 103
                echo "                   <li>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["cita"]) ? $context["cita"] : $this->getContext($context, "cita")), "procedimiento", array(), "array"), "html", null, true);
                echo " a las ";
    ...
    <tbody>
        ";
            ...
            <td>";
                ...
                ";
                // line 129
                if ($this->getAttribute($this->getAttribute((isset($context["cupos"]) ? $context["cupos"] : $this->getContext($context, "cupos")), "distribucionProcedimiento", array(), "array"), "nombreTipoDistribucion", array(), "array")) {
                    // line 130
                    echo "                 <strong> ";
                    echo twig_escape_filter($this->env, ("Horario para " . $this->getAttribute($this->getAttribute((isset($context["cupos"]) ? $context["cupos"] : $this->getContext($context, "cupos")), "distribucionProcedimiento", array(), "array"), "nombreTipoDistribucion", array(), "array")), "html", null, true);
                    echo " </strong>
                ";
                }
                // line 132
            ...
            <td>";
                // line 133
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["cupos"]) ? $context["cupos"] : $this->getContext($context, "cupos")), "nombreEmpleado", array(), "array"), "html", null, true);
                echo "</td>
...
";
    ...
    <ul>
        <li>El Procedimiento <strong> ";
            // line 167
            echo twig_escape_filter($this->env, (isset($context["nombreProcedimiento"]) ? $context["nombreProcedimiento"] : $this->getContext($context, "nombreProcedimiento")), "html", null, true);
            echo "</strong>ya no tiene cupos disponible en las distribuciones creadas </li>
        <li>Ninguna distribución ha sido creada para el Procedimiento <strong> ";
            // line 168
            echo twig_escape_filter($this->env, (isset($context["nombreProcedimiento"]) ? $context["nombreProcedimiento"] : $this->getContext($context, "nombreProcedimiento")), "html", null, true);
            echo "</strong>
...
";
    ...
    {
        return "MinsalCitasBundle:CitCitasProcedimientos:cupos_disponibles.html.twig";
    }
