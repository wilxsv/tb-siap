...
/* MinsalCitasBundle::produccionCitasRecurso.html.twig */
class __TwigTemplate_0a4fd5ddbf9ce2f4a0719b53a2b95a74e0910c67073c05cf773b3b24ab5f9bc5 extends Twig_Template
{
...
";
    ...
    \$(document).ready(function () {
        ...
        var rangoFechas=\$('#rango_fechas');

        rangoFechas.val(now.format('DD/MM/YYYY')+' - '+now.format('DD/MM/YYYY'));

        \$('#buscar').on('click',function(e){
            if(rangoFechas.val() !='' && idAreaModEstab.select2('val')!=''){
                \$('#resultado').waitMe({ text: 'Buscando...' });
                \$('#resultado').load(Routing.generate(\"cargar_produccion_citas_recurso\",{'datos':\$('#formBusqueda').serialize()}),
                ...
                var body=\"Debe de seleccionar el rango de fechas a buscar\";
    ...
    <div class=\"row\">
        <form id=\"formBusqueda\" method=\"post\" >
            <div class=\"col-md-7 col-md-offset-2\">
                <h2 class=\"text-center\">Produccion de citas por empleado</h2>
                <img src=\"";
        // line 62
        ...
        echo "                            </select></td>
                        ...
                        <tr>
                            <th>Rango de Fechas:<span class=\"glyphicon glyphicon-info-sign fd_help_msg\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"Rango de fecha en que fue otorgada la cita\"></span></th>
...
";
    ...
    {
        return "MinsalCitasBundle::produccionCitasRecurso.html.twig";
    }
