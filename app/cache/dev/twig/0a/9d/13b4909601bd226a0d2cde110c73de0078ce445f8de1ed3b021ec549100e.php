...
/* MinsalCitasBundle:Reports/CitasProcedimientos:cargarFechasLibres.html.twig */
class __TwigTemplate_0a9d13b4909601bd226a0d2cde110c73de0078ce445f8de1ed3b021ec549100e extends Twig_Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["procedimiento"] => $context["horario"]) {
            // line 32
            echo "            <tr>
                <td>";
            // line 33
            ...
            echo "</td>
                ";
            // line 34
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "cupos", array(), "array")) > 0)) {
                // line 35
                echo "                <td>
                        ";
                // line 36
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "cupos", array(), "array"), 0, array(), "array"), "fecha", array(), "array"), "html", null, true);
                echo " Con el horario ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "cupos", array(), "array"), 0, array(), "array"), "rangoHora", array(), "array"), "html", null, true);
                echo "
                        ";
                // line 37
                $context["diasEspera"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["horario"]) ? $context["horario"] : $this->getContext($context, "horario")), "cupos", array(), "array"), 0, array(), "array"), "fechaObjeto", array(), "array"), "diff", array(0 => $this->getAttribute(twig_date_converter($this->env), "setTime", array(0 => 0, 1 => 0), "method")), "method"), "format", array(0 => "%a"), "method");
                // line 38
                echo "                </td>
                <td>";
                // line 39
        ...
        unset($context['_seq'], $context['_iterated'], $context['procedimiento'], $context['horario'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "MinsalCitasBundle:Reports/CitasProcedimientos:cargarFechasLibres.html.twig";
    }
