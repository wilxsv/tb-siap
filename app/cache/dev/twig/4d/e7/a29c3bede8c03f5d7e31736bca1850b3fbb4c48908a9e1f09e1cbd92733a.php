...
/* MinsalCitasBundle:CitDistribucion:cargar_distribucion.html.twig */
class __TwigTemplate_4de7a29c3bede8c03f5d7e31736bca1850b3fbb4c48908a9e1f09e1cbd92733a extends Twig_Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["distribucion"]) {
            ...
            echo "            <tr>
                <td>";
            // line 36
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getYrs", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 37
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getNombreMes", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 38
            ...
            echo "</td>
                <td>";
            // line 39
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdRangohora", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdTipoDistribucion", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 41
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdConsultorio", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 42
            ...
            echo "</td>
                <td>";
            // line 45
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdEmpleado", array(), "method"), "html", null, true);
            echo "</td>
                <td>";
            // line 46
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdEstadoDistribucion", array(), "method"), "html", null, true);
            echo "</td>
                <td>
                    ";
            // line 48
            if (($this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdEstadoDistribucion", array(), "method") != "Cerrado")) {
                // line 49
                echo "                        ";
                if ((!$this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "hasRole", array(0 => "ROLE_SUPER_ADMIN"), "method"))) {
                    // line 50
                    echo "                            ";
                    if (($this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getYrs", array(), "method") > twig_date_format_filter($this->env, "now", "Y"))) {
                        // line 51
                        echo "                                <a id=\"borrar\" class=\"btn btn-sm btn-default view_link\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_minsal_citas_citdistribucion_delete", array("id" => $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "id"))), "html", null, true);
                        echo "\"><i class=\"glyphicon glyphicon-remove\"></i>&nbsp; Borrar/Cerrar</a>
                            ";
                    } elseif (($this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getMes", array(), "method") >= twig_date_format_filter($this->env, "now", "m"))) {
                        // line 53
                        echo "                                <a id=\"borrar\" class=\"btn btn-sm btn-default view_link\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_minsal_citas_citdistribucion_delete", array("id" => $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "id"))), "html", null, true);
                        echo "\"><i class=\"glyphicon glyphicon-remove\"></i>&nbsp; Borrar/Cerrar</a>
                ...
                // line 58
                echo "                    ";
            } elseif (($this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "getIdEstadoDistribucion", array(), "method") == "Cerrado")) {
                // line 59
                echo "                        <a id=\"borrar\" class=\"btn btn-sm btn-success view_link\" href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_minsal_citas_citdistribucion_activar", array("id" => $this->getAttribute((isset($context["distribucion"]) ? $context["distribucion"] : $this->getContext($context, "distribucion")), "id"))), "html", null, true);
                echo "\"><i class=\"glyphicon glyphicon-ok\"></i>&nbsp; Activar</a>
                    ";
            }
            // line 61
            echo "                </td>
...
";
    ...
    {
        return "MinsalCitasBundle:CitDistribucion:cargar_distribucion.html.twig";
    }
